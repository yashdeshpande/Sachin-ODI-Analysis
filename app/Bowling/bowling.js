...
// .controller('bowlingGridController', ['$scope', '$http', 'uiGridConstants', function ($scope, $http, uiGridConstants) {
//   var today = new Date();
